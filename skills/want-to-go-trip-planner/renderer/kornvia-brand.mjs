...
export const REPORT_TEMPLATE_VERSION = "kornvia-passport-1.2.3";
...
:root{--yellow:#F9BB16;--cream:#F8EAC7;--paper:#FFFDF8;--ink:#141414;
...
.request-form .submit{border:3px solid var(--ink);border-radius:999px;background:var(--yellow);color:var(--ink);
